...
function smokesCalculator() {
    ...
    $("#weed-info").html(`</div><div class="weed-info-strain">Cepa<span>${weed[selectedWeed].strain}</span></div><div class="weed-info-thc">THC<span>${parseInt(weed[selectedWeed].thc)} % <span class="thc-strength"></span></span></div><div class="weed-info-cbd">CBD <span class="cbd-strength"></span><span>${weed[selectedWeed].cbd} %</span></div><div class="weed-info-link"><span><a href="${weed[selectedWeed].linktoSource}"></span>Leer más sobre el producto</a></div>`)
